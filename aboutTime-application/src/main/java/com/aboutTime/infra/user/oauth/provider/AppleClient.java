...
import com.aboutTime.common.exception.oauth.OAuthRegisterFailException;
import com.aboutTime.domain.user.OAuthProvider;
import com.aboutTime.dto.user.ApplePublicKeys;
import com.aboutTime.dto.user.AppleTokenPayload;
...
public class AppleClient implements OAuthProviderClient {
    ...
    @Override
    public OAuthRegisterCommand getOAuthRegisterInfo(String accessToken) {
