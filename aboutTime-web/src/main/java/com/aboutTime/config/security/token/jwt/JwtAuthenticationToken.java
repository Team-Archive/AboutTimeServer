package com.aboutTime.config.security.token.jwt;

import com.aboutTime.config.security.common.UserPrincipal;
...
public class JwtAuthenticationToken implements Authentication {
    ...
    public JwtAuthenticationToken(UserInfo token) {
        ...
        principal = UserPrincipal
                ...
                .userInfo(token)
                .build();
        details = new User(token.getUserMail(), "", authorities);
        userInfo = token;
    }
